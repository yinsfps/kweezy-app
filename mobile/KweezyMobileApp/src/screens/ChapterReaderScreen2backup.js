...
const createThemedStyles = (theme, fontSize = 18) => StyleSheet.create({
  ...
  segmentOuterContainer: { marginBottom: 20, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: theme.border + '30', },
  segmentText: {
      fontSize: fontSize,
  ...
  commentHeader: {
      ...
      marginBottom: 12, borderBottomWidth: 1, borderBottomColor: theme.border, paddingBottom: 8,
  },
  commentSectionTitle: { fontSize: 17, fontWeight: '600', color: theme.text, },
  reactionBar: { flexDirection: 'row', },
  reactionButton: { flexDirection: 'row', alignItems: 'center', marginLeft: 10, padding: 4, },
